...
tablas = ['SP_PERSONAS_BFV', 'SP_PROFESIONALES_BFV', 'SP_ESTADOS_BFV','SP_OPERACIONES_BFV']
nombre_tabla = tablas[3]
...
match nombre_tabla:
    ...
    case 'SP_ESTADOS_BFV':
        with open("Estados.txt", "w", encoding="utf-8") as file:
            file.write(ObtenerDatos.estados(orden_array,mim_orden, max_orden))
    case 'SP_OPERACIONES_BFV':
        with open("Operaciones.txt", "w", encoding="utf-8") as file:
